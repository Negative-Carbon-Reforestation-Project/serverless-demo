...
/**
 * Container for the Privacy page
 * @returns {JSX.Element}
 */
const Privacy = () => {
                ...
                <section className="privacy-content" tabIndex={0} aria-label="Privacy Policy" role="document">
                    ...
                    <article className="content-article">
                        ...
                        <ul className="privacy-definitions">
                            ...
                            <li>
                                <p><strong>Website</strong> refers to Negative Carbon Reforestation Project, accessible from <a href="https://www.ncrp.app" rel="external nofollow noopener noreferrer" target="_blank">https://www.ncrp.app</a></p>
                            </li>
                            <li>
